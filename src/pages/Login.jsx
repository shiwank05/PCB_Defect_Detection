...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 flex items-center justify-center px-4 relative overflow-hidden">
      ...
      {/* Scan line */}
      <div className="absolute left-0 right-0 h-px bg-cyan-400 opacity-30 transition-none pointer-events-none"
        style={{ top: `${scanLine}%` }} />
      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 bg-cyan-400/10 border border-cyan-400/30 rounded-full px-4 py-1.5 mb-4">
            ...
            <span className="text-cyan-400 text-xs font-mono tracking-widest">SYSTEM ACCESS</span>
          </div>
          <h1 className="text-3xl font-bold text-white mb-1">Welcome Back</h1>
          <p className="text-gray-400 text-sm">Sign in to access PCB Defect Detection</p>
        </div>
