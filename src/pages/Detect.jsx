      ...
      <main className="dt-main" style={{ opacity: revealed ? 1 : 0, transform: revealed ? "translateY(0)" : "translateY(14px)", transition: "all 0.8s cubic-bezier(0.4,0,0.2,1)" }}>
        ...
        <div className="dt-left">
          ...
          <div className="dt-model-info">
            ...
            <div className="dt-model-row">
              <span className="dt-model-key">BACKEND</span>
              <span className="dt-model-val" style={{ color: "#00ff78" }}>RENDER · LIVE</span>
            </div>
          </div>
        ...
        <div className="dt-right">
          ...
          {!loading ? (
            <button className={`dt-btn${!image ? " dt-btn-disabled" : ""}`} onClick={handleSubmit} disabled={!image}>
